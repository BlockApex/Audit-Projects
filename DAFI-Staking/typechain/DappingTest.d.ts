...
interface DappingTestInterface extends ethers.utils.Interface {
  functions: {
    "getWeights(uint256)": FunctionFragment;
    "probeWeights()": FunctionFragment;
    "setUp()": FunctionFragment;
    "test_APW(uint256,uint32,uint128)": FunctionFragment;
  };
...
export class DappingTest extends BaseContract {
  ...
  interface: DappingTestInterface;
  ...
  callStatic: {
    ...
    probeWeights(overrides?: CallOverrides): Promise<void>;
