...
interface StakingManagerV2Interface extends ethers.utils.Interface {
  functions: {
    "STAKING_ON()": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "STAKING_ON", data: BytesLike): Result;
  ...
  events: {
    ...
    "REWARD_DISBURSED(address,uint256,uint256,uint256,uint256,uint256)": EventFragment;
    "STAKED(address,uint256,uint256,uint256,uint256,uint256)": EventFragment;
    "UNSTAKED(address,uint256,uint256,uint256,uint256,uint256)": EventFragment;
  };
...
export class StakingManagerV2 extends BaseContract {
  ...
  interface: StakingManagerV2Interface;

  functions: {
    STAKING_ON(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    STAKING_ON(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    STAKING_ON(overrides?: CallOverrides): Promise<PopulatedTransaction>;
