...
export interface UnipilotActiveFactoryInterface extends utils.Interface {
  functions: {
...
export interface UnipilotActiveFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnipilotActiveFactoryInterface;
