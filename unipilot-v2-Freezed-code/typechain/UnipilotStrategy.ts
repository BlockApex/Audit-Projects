...
export interface UnipilotStrategyInterface extends utils.Interface {
  functions: {
    ...
    "setBaseTicks(address[],int24[])": FunctionFragment;
...
export interface UnipilotStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnipilotStrategyInterface;
